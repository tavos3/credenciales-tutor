...
$consulta = $mysqli->prepare ("SELECT * from retiroalm a INNER JOIN alm b on a.matricula = b.matricula;");
$consulta->execute();
...
class PDF extends FPDF
	{
		function Header()
		{
			...
			$this->Cell(30);
			$this->Cell(230,25, 'REPORTE DE RETIROS DE ALUMNOS DE TODOS LOS GRADOS',0,0,'C');
			$this->Ln(40);
		}
